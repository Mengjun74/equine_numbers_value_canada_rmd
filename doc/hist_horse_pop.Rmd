...
knitr::kable(max_horses, caption = "Horses")
```

Below we zoom in and look at the province of Alberta:

```{r plot province, fig.width=5, fig.height=4, fig.cap="Provinces", message=FALSE, fig.align='center'}
...
```{r out.height='500px', out.width='1000px'}
